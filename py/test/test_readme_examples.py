# Sotaproject SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SotaprojectSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SotaprojectSDK(...) and SotaprojectSDK.test(...) become
#      SotaprojectSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "sotaproject_sdk"
_SDK_CLASS = "SotaprojectSDK"
