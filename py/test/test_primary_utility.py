...
from sotaproject_sdk.core.spec import SotaprojectSpec
from sotaproject_sdk.core.result import SotaprojectResult
from sotaproject_sdk.core.response import SotaprojectResponse
from sotaproject_sdk.core.operation import SotaprojectOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return SotaprojectError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = SotaprojectSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = SotaprojectSDK.test(None, None)
        ...
        class TestInitFeature(SotaprojectBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(SotaprojectBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = SotaprojectSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = SotaprojectSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = SotaprojectOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = SotaprojectSDK.test(None, setup_opts)
