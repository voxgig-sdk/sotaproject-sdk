...
from sotaproject_sdk.core.helpers import get_ctx_prop, to_map
...
class SotaprojectContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, SotaprojectSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SotaprojectResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SotaprojectResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SotaprojectError(code, msg, self)
