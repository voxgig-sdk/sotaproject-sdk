...
from sotaproject_sdk.utility import register

# Load features
from sotaproject_sdk.feature.base_feature import SotaprojectBaseFeature
from sotaproject_sdk.features import _has_feature, _make_feature
...
class SotaprojectSDK:
    ...
    def get_utility(self):
        return SotaprojectUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SotaprojectSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Publication(self, data=None) -> "PublicationEntity":
        ...
        from sotaproject_sdk.entity.publication_entity import PublicationEntity
        return PublicationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "SotaprojectSDK":
        if sdkopts is None:
            sdkopts = {}
