# Sotaproject Python SDK



The Python SDK for the Sotaproject API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Publication()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/sotaproject-sdk/releases)) or
...
```
py/
├── sotaproject_sdk.py         -- Main SDK module
