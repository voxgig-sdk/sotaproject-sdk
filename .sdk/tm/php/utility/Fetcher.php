...
// Sotaproject SDK utility: fetcher

class SotaprojectFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SotaprojectSDK/1.0)';
    ...
    public static function call(SotaprojectContext $ctx, string $fullurl, array $fetchdef): array
    {
