...
// Sotaproject SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SotaprojectOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SotaprojectOmni::structfix($now, Struct::undef()))
                        !== json_encode(SotaprojectOmni::structfix($val, Struct::undef()))) {
