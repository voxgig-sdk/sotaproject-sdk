...
class SotaprojectRbacFeature extends SotaprojectBaseFeature
{
    ...
    private function _required(SotaprojectContext $ctx): ?string
    {
    ...
    private function _reject(SotaprojectContext $ctx, string $required): void
    {
    ...
    private function _track(SotaprojectContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
