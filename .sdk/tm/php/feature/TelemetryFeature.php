...
// Sotaproject SDK telemetry feature
...
class SotaprojectTelemetryFeature extends SotaprojectBaseFeature
{
    ...
    private function _close(SotaprojectContext $ctx, bool $ok): void
    {
