...
// Sotaproject SDK metrics feature
...
class SotaprojectMetricsFeature extends SotaprojectBaseFeature
{
    ...
    private function _record(SotaprojectContext $ctx, bool $ok): void
    {
