...
// Sotaproject SDK idempotency feature
...
class SotaprojectIdempotencyFeature extends SotaprojectBaseFeature
{
    ...
    private function _mutating(SotaprojectContext $ctx): bool
    {
