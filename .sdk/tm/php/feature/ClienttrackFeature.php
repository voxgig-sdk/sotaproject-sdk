...
// Sotaproject SDK clienttrack feature
...
class SotaprojectClienttrackFeature extends SotaprojectBaseFeature
{
    ...
    public function PostConstruct(SotaprojectContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Sotaproject-SDK';
