...
// Sotaproject SDK ratelimit feature
...
class SotaprojectRatelimitFeature extends SotaprojectBaseFeature
{
    ...
    private function _acquire(SotaprojectContext $ctx): void
    {
    ...
    private function _track(SotaprojectContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
