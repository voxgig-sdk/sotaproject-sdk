...
// Sotaproject SDK streaming feature
...
class SotaprojectStreamingFeature extends SotaprojectBaseFeature
{
    ...
    private function _iterate(SotaprojectResult $result): \Generator
    {
    ...
    private function _streamable(SotaprojectContext $ctx): bool
    {
