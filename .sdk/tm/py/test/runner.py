...
class SotaprojectTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SotaprojectTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SotaprojectTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SotaprojectTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
