...
class SotaprojectTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SotaprojectTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = SotaprojectTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = SotaprojectTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
