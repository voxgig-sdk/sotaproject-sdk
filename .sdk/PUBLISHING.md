...
|---|---|---|
| `ts/` | @voxgig-sdk/sotaproject-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/sotaproject-sdk \
      --repository voxgig-sdk/sotaproject-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/sotaproject-sdk` shows it, and
`npm trust revoke @voxgig-sdk/sotaproject-sdk --id=<id>` removes it.
