...
type Args struct {
	Entity string         `json:"entity" jsonschema:"publication"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SotaprojectSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "sotaproject_list",
		Description: "List records from Sotaproject. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "sotaproject_load",
		Description: "Load a single record from Sotaproject. " +
...
func runOp(client *sdk.SotaprojectSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SotaprojectSDK, name string) (sdk.SotaprojectEntity, error) {
