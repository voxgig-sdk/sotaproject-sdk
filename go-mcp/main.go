// Command Sotaproject-mcp is an MCP server exposing the Sotaproject
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Sotaproject_list  — list records of an entity
//	Sotaproject_load  — load a single record of an entity
//
