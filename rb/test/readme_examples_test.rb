...
#      offline in seeded test mode (SotaprojectSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Sotaproject_sdk.rb")
  SDK_CLASS = "SotaprojectSDK"
