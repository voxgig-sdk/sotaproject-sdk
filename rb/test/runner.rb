...
module SotaprojectTestRunner
  ...
  def self.env_override(m)
    live = getenv("SOTAPROJECT_TEST_LIVE")
    override = getenv("SOTAPROJECT_TEST_OVERRIDE")
    ...
    explain = getenv("SOTAPROJECT_TEST_EXPLAIN")
    m["SOTAPROJECT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = SotaprojectTestRunner
Helpers = SotaprojectHelpers
Vs = VoxgigStruct
