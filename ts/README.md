# Sotaproject TypeScript SDK



The TypeScript SDK for the Sotaproject API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Publication()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `SotaprojectSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `SotaprojectSDK.test(testopts?, sdkopts?)` | `SotaprojectSDK` | Create a test-mode client. |
...
| `client` | `client(): SotaprojectSDK` | Return the parent SDK client. |
...
sotaproject/
├── src/
│   ├── SotaprojectSDK.ts        # Main SDK class
