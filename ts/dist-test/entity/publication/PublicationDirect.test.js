...
(0, node_test_1.describe)('PublicationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SotaprojectSDK({
    ...
    (0, node_test_1.test)('direct-list-publication', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-publication', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SotaprojectSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['SOTAPROJECT_TEST_PUBLICATION_ENTID'];
    ...
    const client = new __1.SotaprojectSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PublicationDirect.test.js.map