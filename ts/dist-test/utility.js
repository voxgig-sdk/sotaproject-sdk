...
function envOverride(m) {
    if ('TRUE' === process.env.SOTAPROJECT_TEST_LIVE ||
        'TRUE' === process.env.SOTAPROJECT_TEST_OVERRIDE) {
    ...
    m.SOTAPROJECT_TEST_EXPLAIN = process.env.SOTAPROJECT_TEST_EXPLAIN || m.SOTAPROJECT_TEST_EXPLAIN;
    return m;
}
