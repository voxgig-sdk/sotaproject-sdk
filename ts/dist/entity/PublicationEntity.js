...
class PublicationEntity extends SotaprojectEntityBase_1.SotaprojectEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'publication';
        this.name_ = 'publication';
        this.Name = 'Publication';
    }
    make() {
        return new PublicationEntity(this._client, this.entopts());
    }
