...
exports.SotaprojectEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends SotaprojectEntityBase<Advice>`.
class SotaprojectEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.SotaprojectEntityBase = SotaprojectEntityBase;
//# sourceMappingURL=SotaprojectEntityBase.js.map