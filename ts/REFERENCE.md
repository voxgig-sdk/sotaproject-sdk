# Sotaproject TypeScript SDK Reference

Complete API reference for the Sotaproject TypeScript SDK.
...
```ts
new SotaprojectSDK(options?: object)
```
...
#### `SotaprojectSDK.test(testopts?, sdkopts?)`
...
**Returns:** `SotaprojectSDK` instance in test mode.
...
Return the parent `SotaprojectSDK` instance.
