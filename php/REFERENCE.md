# Sotaproject PHP SDK Reference

Complete API reference for the Sotaproject PHP SDK.
...
#### `SotaprojectSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): SotaprojectUtility`
