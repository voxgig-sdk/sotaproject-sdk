...
// Sotaproject SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SotaprojectSDK::test)
...
{
    private const SDK_CLASS = 'SotaprojectSDK';
    ...
    private const SDK_BASE = 'sotaproject_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../sotaproject_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
