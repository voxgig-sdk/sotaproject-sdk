...
class SotaprojectTestRunner
{
    ...
    {
        $live = self::getenv('SOTAPROJECT_TEST_LIVE');
        $override = self::getenv('SOTAPROJECT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SOTAPROJECT_TEST_EXPLAIN');
...
class_alias('SotaprojectTestRunner', 'Runner');
class_alias('SotaprojectHelpers', 'Helpers');
