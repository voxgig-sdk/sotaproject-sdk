...
{
    private static function utility(): SotaprojectUtility
    {
        return new SotaprojectUtility();
    }
    ...
    private static function ctx(array $over = []): SotaprojectContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SotaprojectContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SotaprojectOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SotaprojectError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SotaprojectOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SotaprojectMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SotaprojectOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SotaprojectMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SotaprojectOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SotaprojectMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SotaprojectSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SotaprojectMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SotaprojectResponse([]),
            'result' => new SotaprojectResult([]),
        ]);
        [, $err] = SotaprojectMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SotaprojectSpec([]),
            'response' => null,
            'result' => new SotaprojectResult([]),
        ]);
        [, $err] = SotaprojectMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SotaprojectSpec(['step' => 's']),
            'response' => new SotaprojectResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SotaprojectResult([]),
        ]);
        [, $err] = SotaprojectMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SotaprojectSpec(['step' => 's']),
            'response' => new SotaprojectResponse(self::resp(200, ['v' => 1])),
            'result' => new SotaprojectResult([]),
        ]);
        [, $err] = SotaprojectMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SotaprojectSpec(['step' => 's']),
            'response' => new SotaprojectResponse(self::resp(200, ['v' => 2])),
            'result' => new SotaprojectResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SotaprojectMakeResponse::call($ctx);
    ...
    {
        $preset = new SotaprojectResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SotaprojectSpec([]),
            'response' => new SotaprojectResponse([]),
            'result' => new SotaprojectResult([]),
        ...
        [$got, $err] = SotaprojectMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SotaprojectResult([])]);
        [, $err] = SotaprojectMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SotaprojectSpec([]), 'result' => null]);
        [, $err] = SotaprojectMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SotaprojectSpec(['step' => 's']),
            'result' => new SotaprojectResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SotaprojectOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SotaprojectMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SotaprojectSpec(['step' => 's']),
            'result' => new SotaprojectResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SotaprojectOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SotaprojectMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SotaprojectResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SotaprojectSpec([]),
            'result' => new SotaprojectResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SotaprojectMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SotaprojectMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SotaprojectError('boom', 'boom');
        $utility->fetcher = function (SotaprojectContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SotaprojectSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SotaprojectMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SotaprojectContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SotaprojectMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SotaprojectResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SotaprojectMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SotaprojectContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SotaprojectSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SotaprojectMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SotaprojectResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SotaprojectSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SotaprojectMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SotaprojectMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SotaprojectMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SotaprojectResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SotaprojectDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SotaprojectResult(['ok' => false])]);
        $this->expectException(SotaprojectError::class);
        SotaprojectDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SotaprojectResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SotaprojectMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SotaprojectMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SotaprojectBaseFeature();
        $b = new SotaprojectBaseFeature();
        SotaprojectFeatureAdd::call($ctx, $a);
        SotaprojectFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SotaprojectBaseFeature
    {
        $f = new SotaprojectBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SotaprojectFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SotaprojectContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SotaprojectSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SotaprojectPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SotaprojectPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SotaprojectResponse(['headers' => null]),
            'result' => new SotaprojectResult([]),
        ]);
        SotaprojectResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        SotaprojectResultBody::call($ctx);
