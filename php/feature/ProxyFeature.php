...
class SotaprojectProxyFeature extends SotaprojectBaseFeature
{
    ...
    public function init(SotaprojectContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SotaprojectContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
