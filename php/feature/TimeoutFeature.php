...
// Sotaproject SDK timeout feature
...
class SotaprojectTimeoutFeature extends SotaprojectBaseFeature
{
    ...
    private function _with_timeout(SotaprojectContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SotaprojectContext $_ctx, float $ms): void
    {
        $client = $this->client;
