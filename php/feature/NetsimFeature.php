...
// Sotaproject SDK netsim feature
...
class SotaprojectNetsimFeature extends SotaprojectBaseFeature
{
    ...
    private function _simulate(SotaprojectContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SotaprojectContext $ctx, array $applied): void
    {
        $client = $this->client;
