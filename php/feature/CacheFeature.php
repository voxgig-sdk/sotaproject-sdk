...
class SotaprojectCacheFeature extends SotaprojectBaseFeature
{
    ...
    private function _through(SotaprojectContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
