...
// Sotaproject SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SotaprojectTestFeature extends SotaprojectBaseFeature
{
    ...
    public function init(SotaprojectContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SotaprojectContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = SotaprojectParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SotaprojectContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SotaprojectContext $ctx, $op, $args): array
    {
