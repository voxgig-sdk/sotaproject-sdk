...
// Sotaproject SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SotaprojectMakeRequest
{
    public static function call(SotaprojectContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SotaprojectResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SotaprojectResponse($fetched);
        } else {
