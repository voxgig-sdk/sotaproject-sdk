...
// Sotaproject SDK utility: graphql
//
...
class SotaprojectGraphql
{
    ...
    // equivalent.
    public static function body(SotaprojectContext $ctx): mixed
    {
    ...
    public static function errors(SotaprojectContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
