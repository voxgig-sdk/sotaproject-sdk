...
function runner.env_override(m)
  local live = runner.getenv("SOTAPROJECT_TEST_LIVE")
  local override = runner.getenv("SOTAPROJECT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SOTAPROJECT_TEST_EXPLAIN")
