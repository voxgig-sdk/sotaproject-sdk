...
describe("PublicationDirect", function()
  it("should direct-list-publication", function()
    local setup = publication_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-publication", setup.live and "live" or "unit")
