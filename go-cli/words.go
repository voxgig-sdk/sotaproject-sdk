...
func registerSDKWords(r *eng.Registry, client *sdk.SotaprojectSDK) {
...
func runOp(client *sdk.SotaprojectSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
