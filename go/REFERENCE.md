# Sotaproject Golang SDK Reference

Complete API reference for the Sotaproject Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *SotaprojectSDK`
...
#### `Publication(data map[string]any) SotaprojectEntity`
...
| `media` | `[]any` | No | Media content associated with the publication |
