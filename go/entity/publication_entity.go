...
import (
	...
	vs "github.com/voxgig-sdk/sotaproject-sdk/go/utility/struct"
)

type PublicationEntity struct {
	name    string
	client  *core.SotaprojectSDK
...
func NewPublicationEntity(client *core.SotaprojectSDK, entopts map[string]any) *PublicationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PublicationEntity) GetName() string { return e.name }
...
func (e *PublicationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PublicationEntity) Deleted() bool {
	return e.deleted
}


func (e *PublicationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPublicationEntity(e.client, opts)
}

func (e *PublicationEntity) Data(args ...any) any {
...
func (e *PublicationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Publication; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PublicationEntity) DataTyped(data ...Publication) Publication {
	if len(data) > 0 {
		return typedFrom[Publication](e.Data(asMap(data[0])))
	}
	return typedFrom[Publication](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Publication (all fields
// optional at the wire level).
func (e *PublicationEntity) MatchTyped(match ...Publication) Publication {
	if len(match) > 0 {
		return typedFrom[Publication](e.Match(asMap(match[0])))
	}
	return typedFrom[Publication](e.Match())
}
...
func (e *PublicationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PublicationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PublicationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PublicationListMatch and returns []Publication. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PublicationEntity) ListTyped(reqmatch PublicationListMatch, ctrl map[string]any) ([]Publication, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Publication](res), nil
}



func (e *PublicationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PublicationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PublicationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PublicationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
